...
mesh::mesh(abstractMeshLoader* loader, const std::string& filepath_, const std::string& material_, int depthFunc_, bool backfaceCulling_, int cullType_) : abstractResource(), model(1.0f), vertices(), indices() {
